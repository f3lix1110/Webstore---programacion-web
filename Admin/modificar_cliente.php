                                        ...
                                        window.location.href=dominio;
                                                          ...
                                                          function recibe() {
                                                            ...
                                                            if(user) {
                                                                ...
                                                                document.forma01.action = 'recibe_modificar_cliente.php';
...
$con = conecta();
 ...
 $sql = "SELECT * FROM clientes WHERE id = $id_detalle AND eliminado = 0";
 ...
 $num = mysql_num_rows($res);      //devuelve el numero de filas de la variable resultado (res)
    ...
    <form method='post' action='recibe_modificar_cliente.php' enctype='multipart/form-data'>
    
     <tr> <td colspan='3' align='center'> ID: $id </td> </tr>
     <tr> <td colspan='2' align='center'> <img src = \"../archivos/clientes/$archivo_n\" width=\"400px\" heigth=\"280px\"></img> </td> 
