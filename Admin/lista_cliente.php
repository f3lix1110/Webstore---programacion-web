...
function enviar3(id){
  var dominio = 'formulario_cliente.php';
  window.location.href=dominio;
 }

      function enviar2(id){
       var dominio = 'modificar_cliente.php?sd='+id;
       window.location.href=dominio;
      }
 
                function enviar(id){
                  var dominio = 'detalles_cliente.php?sd='+id;
                  window.location.href=dominio;
                }
...
";
  ...
  echo "<td align='center'> Avatar </td>  <td align='center'> Nombre </td>  <td align='center'> Apellido </td> <td align='center'> Correo </td> <td colspan='3'; align='center'> Opciones </td>";
    //for que imprime todos los administradores
     ...
     <td> <img src = \"../archivos/clientes/$archivo_n\" width=\"100px\" heigth=\"70px\"></img> </td> 
