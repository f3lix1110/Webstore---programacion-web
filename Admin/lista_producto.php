...
function enviar3(id){
  var dominio = 'formulario_producto.php';
  window.location.href=dominio;
 }

      function enviar2(id){
       var dominio = 'modificar_producto.php?sd='+id;
       window.location.href=dominio;
      }
 
                function enviar(id){
                  var dominio = 'detalles_producto.php?sd='+id;
                  window.location.href=dominio;
                }
...
echo "
<input onclick='enviar3();' type='submit' name='regresa' style='width:auto; position: relative; left: 56%; font-size:18; cursor:pointer;' value='Agregar Nuevo' />
";

  echo "<table border = 2 class='tabla' align='center'>";
  echo "<td align='center'> Imagen </td>  <td align='center'> Nombre </td>  <td align='center'> Codigo </td> <td align='center'> Costo </td> <td colspan='3'; align='center'> Opciones </td>";
    //for que imprime todos los administradores
     ...
     <td> <img src = \"../archivos/productos/$archivo_n\" width=\"100px\" heigth=\"70px\"></img> </td> 
     <td> $nombre </td>  <td> $codigo </td> <td> $$costo </td>
